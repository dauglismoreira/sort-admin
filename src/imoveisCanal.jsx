...
const ImoveisCanal = props => {
  ...
  return (
    ...
    <React.Fragment>
      ...
      <div className="container-imoveis">
        {searchResults.filter(imovelfilter => imovelfilter.integration_zap === '1')
...
export default connect(mapStateToProps, mapDispatchToProps)(ImoveisCanal)
