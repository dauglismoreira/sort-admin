...
const ImoveisChaves = props => {
  ...
  return (
    ...
    <React.Fragment>
      ...
      <div className="container-imoveis">
        {searchResults.filter(imovelfilter => imovelfilter.integration === '1')
...
export default connect(mapStateToProps, mapDispatchToProps)(ImoveisChaves)
