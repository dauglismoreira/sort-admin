...
const Register = props => {
  ...
  return (
    <React.Fragment>
      <MetaTags>
        <title>Registrar | Sort Investimentos</title>
      </MetaTags>
            ...
            <Col md={8} lg={6} xl={5}>
              <Card className="overflow-hidden">
                <CardBody className="pt-0">
                  ...
                  <div className="p-3">
                    <h4 className="text-muted font-size-18 mb-1 text-center">Cadastre-se</h4>
                    <p className="text-muted text-center">Todos os campos são obrigatórios.</p>
                    <AvForm
