...
const handleStatus = (imovel) => {
  if (imovel.status === '1') {
    ...
    console.log(data);
    axios.put('https://sort.vps-kinghost.net/api/immobile/update/promo' + idU, data);
    setTimeout(() => {
...
const ImoveisDwv = props => {
  ...
  return (
    ...
    <React.Fragment>
      ...
      <div className="container-imoveis">
        {searchResults.filter(imovelfilter => imovelfilter.id_extern)
...
export default connect(mapStateToProps, mapDispatchToProps)(ImoveisDwv)
